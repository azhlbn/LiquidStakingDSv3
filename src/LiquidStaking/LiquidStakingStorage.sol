...
abstract contract LiquidStakingStorage {
    ...
    event PeriodUpdateStakeError(uint256 indexed period, string dappName, bytes reason);
    ...
    event WithdrawBonusRewards(address caller, uint256 indexed period, uint256 amount);
